...
cosmos-rl --config recipes/alpamayo1_x_rl/toml/alpamayo_r1_no_expert_10b_local_test.toml \
  --policy 1 \
  --rollout 1 \
  --log-dir alpamayo_x_rl-logs \
  recipes/alpamayo1_x_rl/models/reasoning_vla/alpamayo_cosmos_rl_post_training_entry_local_test.py
